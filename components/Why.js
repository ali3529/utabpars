...
function Why() {
  return (
    <div >
      <div className='grid sm:grid-cols-2 grid-cols-1 bg-white rounded-[2.5rem] xl:mx-[14rem] lg:mx-[3rem] my-12 lg:px-0 md:px-16 right-6 shadow-lg space-x-12 absolute'
      >
